...
The workshop (http://workshop.ubiquity.grok.tv) provides an example of how to use these functions. To make a copy this script run the following:
...
This should create the folloing script

* ``make_report.R`` Generates a PowerPoint presentation from an R script
