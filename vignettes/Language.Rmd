...
###Simple Covariates 
For simulation purposes covariates (normally found in a dataset) need to be defined. Covariates can be be either constant or change with time. The times values *must be the same scale as the system*. The following defines the value for the covariate ``RACE``:
