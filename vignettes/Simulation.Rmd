...
The workshop ([workshop.ubiquity.tools](https://github.com/john-harrold/ubiquity-pkpd/raw/refs/heads/master/download/ubiquity_workshop.zip) provides several examples of how to perform simulations in ubiquity. To make a copy of these scripts and other supporting files in the current working directory run the following:
...
* [``analysis_single.r``](https://github.com/john-harrold/ubiquity/blob/master/inst/ubinc/scripts/analysis_single.r) Simulating the response for a single indiviudal
* [``analysis_multiple.r``](https://github.com/john-harrold/ubiquity/blob/master/inst/ubinc/scripts/analysis_multiple.r) Mote Carlo simulations using IIV
* [``analysis_multiple_file.r``](https://github.com/john-harrold/ubiquity/blob/master/inst/ubinc/scripts/analysis_multiple_file.r) Monte Carlo simulations reading subject information from a file
