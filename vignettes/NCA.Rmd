...
To get an explanation of the columns in the NCA output you can use the ``system_nca_fetch_columns`` function passing the NCA analysis name to the function. The list output contains a data frame ``NCA_col_summary`` with the outputs and a description of their meaning:

```{r warning=FALSE, message=FALSE, echo=TRUE, error=FALSE, eval=FALSE, results="hide", fig.width=8, fig.height=4}
nca_cols = system_nca_fetch_columns(cfg, "pk_single_dose")
